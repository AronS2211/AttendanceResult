...
<body>
    ...
    <div class="TT-container">
        ...
        <form method="post" action="Studentdataupload.php" style="display: flex;" id="basicinfo"
            enctype="multipart/form-data" class="TT-form">
            ...
            <div class="TT-form-content">
                ...
                <div>
                    ...
                    <input type="file" name="studentProfileImage[]" id="studentProfilePic"
                        placeholder="Upload your picture" onchange="">
                </div>
                <div>
                    <label for="first_name">First Name :</label>
                    <input id="fname" type="text" name="first_name" value="<?php echo $studentData['stu_fname'] ?>"
                        required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input id="dob" type="date" name="date_of_birth" value="<?php echo $studentData['stu_dob'] ?>"
                        required>
                </div>
                <div>
                    ...
                    <span>
                        <input type="radio" id="male" name="gender" value="Male"
                            <?php echo ($studentData['stu_gender'] == 'Male') ? 'checked' : '' ?>>Male
                        <input type="radio" id="female" name="gender" value="Female"
                            <?php echo ($studentData['stu_gender'] == 'Female') ? 'checked' : '' ?>>Female
                    </span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input id="mobileNum" type="number" name="mobile_number"
                        value="<?php echo $studentData['stu_mobile'] ?>" required />
                </div>
                <div>
                    <label for="email">Email ID : </label>
                    <input id="email" type="email" name="email" value="<?php echo $studentData['stu_email'] ?>"
                        required>
                </div>
                <div>
                    ...
                    <select name="coursetype">
                        ...
                        <option value="Regular"
                            <?php echo ($studentData['stu_coursetype'] == 'Regular') ? 'selected' : '' ?>>Regular
                        </option>
                        <option value="Part Time"
                            <?php echo ($studentData['stu_coursetype'] == 'Part Time') ? 'selected' : '' ?>>Part Time
                        </option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="quota">
                        ...
                        <option value="Counselling"
                            <?php echo ($studentData['stu_quota'] == 'Counselling') ? 'selected' : '' ?>>Counselling
                        </option>
                        <option value="Management"
                            <?php echo ($studentData['stu_quota'] == 'Management') ? 'selected' : '' ?>>Management
                        </option>
                    </select>
                </div>
                <div>
                    <label for="counsellingNumber">Counselling Number (Optional) : </label>
                    <input type="number" id="counsellingNumber" value="<?php echo $studentData['stu_counsellingno'] ?>"
                ...
                <div>
                    ...
                    <span>
                        <input type="radio" name="stu_lateral" value="Yes"
                            <?php echo ($studentData['stu_lateral'] == 'Yes') ? 'checked' : ''; ?>> Yes
                        <input type="radio" name="stu_lateral" value="No"
                            <?php echo ($studentData['stu_lateral'] == 'No') ? 'checked' : ''; ?>> No
                    </span>
                </div>

                <div class="TT-form-button">
                    <button type="submit" name="update" id="basicInfoSubmitBtn" class="TT-button">Update
                        Profile</button>
                </div>
            </div>
            <div id="Result"></div>
            ...
            <div class="TT-form-content">
                ...
                <div>
                    ...
                    <select name="stu_bloodgrp">
                        ...
                        <option id="A+" value="A+"
                            <?php echo (isset($studentData['stu_bloodgrp']) && $studentData['stu_bloodgrp'] == 'A+') ? 'selected' : ''; ?>>
                            A+</option>
                        <option id="A-" value="A-"
                            <?php echo (isset($studentData['stu_bloodgrp']) && $studentData['stu_bloodgrp'] == 'A-') ? 'selected' : ''; ?>>
                            A-</option>
                        <option id="B+" value="B+"
                            <?php echo (isset($studentData['stu_bloodgrp']) && $studentData['stu_bloodgrp'] == 'B+') ? 'selected' : ''; ?>>
                            B+</option>
                        <option id="B-" value="B-"
                            <?php echo (isset($studentData['stu_bloodgrp']) && $studentData['stu_bloodgrp'] == 'B-') ? 'selected' : ''; ?>>
                            B-</option>
                        <option id="O+" value="O+"
                            <?php echo (isset($studentData['stu_bloodgrp']) && $studentData['stu_bloodgrp'] == 'O+') ? 'selected' : ''; ?>>
                            O+</option>
                        <option id="O-" value="O-"
                            <?php echo (isset($studentData['stu_bloodgrp']) && $studentData['stu_bloodgrp'] == 'O-') ? 'selected' : ''; ?>>
                            O-</option>
                        <option id="AB+" value="AB+"
                            <?php echo (isset($studentData['stu_bloodgrp']) && $studentData['stu_bloodgrp'] == 'AB+') ? 'selected' : ''; ?>>
                            AB+</option>
                        <option id="AB-" value="AB-"
                            <?php echo (isset($studentData['stu_bloodgrp']) && $studentData['stu_bloodgrp'] == 'AB-') ? 'selected' : ''; ?>>
                            AB-</option>
        ...
        <form method="post" action="Studentdataupload.php" id="Family" enctype="multipart/form-data" class="TT-form">
            <div class="TT-form-content">
                ...
                <div>
                    ...
                    <input type="text" name="stu_fqualification"
                        value="<?php echo $studentData['stu_fqualification'] ?>">
                </div>
                ...
                <div>
                    ...
                    <span>
                        <input type="radio" name="stu_orphan" value="Yes"
                            <?php echo (isset($studentData['stu_orphan']) && $studentData['stu_orphan'] == 'Yes') ? 'checked' : ''; ?>>Yes
                        <input type="radio" name="stu_orphan" value="No"
                            <?php echo (isset($studentData['stu_orphan']) && $studentData['stu_orphan'] == 'No') ? 'checked' : ''; ?>>No
                    </span>
                </div>
        ...
        <form method="post" action="Studentdataupload.php" id="Accommodation" enctype="multipart/form-data"
            class="TT-form">
            <div class="TT-form-content">
                ...
                <div>
                    ...
                    <span>
                        <input type="radio" name="stu_hostel" value="Yes"
                            <?php echo ($studentData['stu_hostel'] == 'Yes') ? 'checked' : ''; ?>> Yes
                        <input type="radio" name="stu_hostel" value="No"
                            <?php echo ($studentData['stu_hostel'] == 'No') ? 'checked' : ''; ?>> No
                    </span>
                </div>
                ...
                <div>
                    ...
                    <span>
                        <input type="radio" name="stu_transport" value="Yes"
                            <?php echo ($studentData['stu_transport'] == 'Yes') ? 'checked' : ''; ?>> Yes
                        <input type="radio" name="stu_transport" value="No"
                            <?php echo ($studentData['stu_transport'] == 'No') ? 'checked' : ''; ?>> No
                    </span>
                </div>
                ...
                <div>
                    ...
                    <span>
                        <input type="radio" name="stu_hosteltype" value="Free"
                            <?php echo ($studentData['stu_hosteltype'] == 'Free') ? 'checked' : ''; ?>> Free
                        <input type="radio" name="stu_hosteltype" value="Paid"
                            <?php echo ($studentData['stu_hosteltype'] == 'Paid') ? 'checked' : ''; ?>> Paid
                    </span>
                </div>
                ...
                <div>
                    ...
                    <span>
                        <input type="radio" name="stu_food" value="Veg"
                            <?php echo ($studentData['stu_food'] == 'Veg') ? 'checked' : ''; ?>> Veg
                        <input type="radio" name="stu_food" value="Non Veg"
                            <?php echo ($studentData['stu_food'] == 'Non Veg') ? 'checked' : ''; ?>> Non Veg
                    </span>
                </div>
        ...
        <form method="post" action="Studentdataupload.php" id="Scholarship" enctype="multipart/form-data"
            class="TT-form">
            <div class="TT-form-content">
                ...
                <div>
                    ...
                    <span>
                        <input type="radio" name="stu_fg" value="Yes"
                            <?php echo ($studentData['stu_fg'] == 'Yes') ? 'checked' : ''; ?>> Yes
                        <input type="radio" name="stu_fg" value="No"
                            <?php echo ($studentData['stu_fg'] == 'No') ? 'checked' : ''; ?>> No
                    </span>
                </div>
        ...
        <form method="post" action="Studentdataupload.php" id="GovernmentDocuments" enctype="multipart/form-data"
            class="TT-form">
            <div class="TT-form-content">
