            ...
            <div class="main-card">
                <div class="card text-bg-light mx-3 my-3">
                    <div class="report-head p-2 d-flex justify-content-between align-items-center">
                        <h3 class="m-0">Manage Timetable</h3>
                        <div>
                    ...
                    <form id="TTform5" method="post" action="#">
                        ...
                        <div class="TT-form-content">
                            ...
                            <div>
                                ...
                                <?php
                                $query3 = "select*from erp_tt_type";
                                ...
                                ?>
                                    <label class="TT-label" for="type">Time Table type:</label>
                    ...
                    if (isset($_POST['search'])) {
                        //code for selecting based on the filters 

                        if ((!empty($_POST['course'])) && (!empty($_POST['department'])) && (!empty($_POST['semester'])) && (!empty($_POST['type']))) { //check if both fields are set
                            $cour = $_POST['course'];
                            ...
                            $query4 = "SELECT * FROM erp_tt_type LEFT JOIN erp_schedule ON erp_tt_type.type_id = erp_schedule.type_id LEFT JOIN erp_class on erp_schedule.class_id=erp_class.cls_id where erp_tt_type.type_id = $type and erp_class.cls_id = $clsid ";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="schedule.php" method="post">
                                                    ...
                                                    <button type="submit" class="TT-button">Schedule</button>
                                                </form>
                                            </td>
                                        </tr>
                                    <?php
